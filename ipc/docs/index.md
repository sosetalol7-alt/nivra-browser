...
For inter-process communication involving Javascript, see {doc}`JSActors </dom/ipc/jsactors>`.
They are a very limited case, used for communication between elements in the DOM,
